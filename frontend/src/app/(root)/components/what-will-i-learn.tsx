import { ArrowRightIcon, ArrowUpRightIcon, InfoIcon, SparkleIcon } from 'lucide-react';
  ...
  return (
    <div className="hero">
      <div className='mb-4 flex flex-col justify-center text-center md:mb-8 md:flex-row md:items-baseline md:justify-center md:text-left text-primary'>
        ...
        <div className="mx-auto my-1 w-[70%] md:ml-2 md:mr-0 md:w-auto md:text-xl text-muted-foreground">Вот несколько наших курсов.</div>
      </div>
      <div className='grid grid-flow-row grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-3'>
        {navConfig.courses.items.map((item, idx) => (
          <div key={idx} className='group h-full rounded-[12px] shadow-sm group transition-all border hover:bg-accent'>
