...
export default function NotFound() {
  return (
    <div className="relative flex flex-col justify-center w-full min-h-svh gap-6 bg-background p-6 md:p-10 max-w-5xl mx-auto">
      <div className="relative">
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 362 145" className="absolute inset-0 opacity-75 text-muted">
          <path
            fill="currentColor"
        ...
        <div className="relative text-center z-[1] pt-64">
